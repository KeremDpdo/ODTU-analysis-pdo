...
if uploaded_file is not None:
    ...
    try:
        ...
        st.success("Dosya başarıyla yüklendi. Fakülte/bölüm isimleri https://www.metu.edu.tr/tr/fakulteler-enstituler-ve-okullar kaynağına göre standardize edildi.")
